...
class FocalLoss2d(pl.LightningModule):
...
class FocalMSE(pl.LightningModule):
...
class RCELoss(pl.LightningModule):
...
class BalanceLoss(pl.LightningModule):
...
class berHuLoss(pl.LightningModule):
...
class SigmoidFocalLoss(pl.LightningModule):
...
class ProbOhemCrossEntropy2d(pl.LightningModule):
